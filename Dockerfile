...
RUN mkdir -p /raspi/rootfs && \
    ...
    rm -r /raspi/rpi-tools/arm-bcm2708/gcc-linaro*
...
# set PATH
ENV PATH /raspi/rpi-tools/arm-bcm2708/arm-rpi-4.9.3-linux-gnueabihf/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
